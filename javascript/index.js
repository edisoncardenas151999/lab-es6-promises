...
// Out of sync
  ...
  const pro1 = obtainInstruction('broccoli',0 )
  const pro2 = obtainInstruction('broccoli',1 )
  const pro3 = obtainInstruction('broccoli',2 )
  const pro4 = obtainInstruction('broccoli',3 )
  const pro5 = obtainInstruction('broccoli',4 )
  const pro6 = obtainInstruction('broccoli',5 )
  const pro7 = obtainInstruction('broccoli',6 )
  document.querySelector("#broccoliImg").removeAttribute('hidden')
   
  
  
  Promise.all([pro1,pro2,pro3,pro4,pro5,pro6,pro7]).then((values)=>{
